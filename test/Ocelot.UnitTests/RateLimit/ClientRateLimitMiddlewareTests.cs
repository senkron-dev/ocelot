    ...
    public class ClientRateLimitMiddlewareTests
    {
        ...
        public void should_call_middleware_and_ratelimiting()
        {
            ...
            var downstreamRoute = new DownstreamRouteBuilder()
                ...
                .WithRateLimitOptions(new RateLimitOptions(true, "ClientId", () => new List<string>(), false, "", "", new RateLimitRule("1s", 100, 3), 429, () => new List<ClientLimit>(), true))
                 ...
                 new RouteBuilder()
                     .WithDownstreamRoute(new DownstreamRouteBuilder()
                         ...
                         .WithRateLimitOptions(
                             new Ocelot.Configuration.RateLimitOptions(true, "ClientId", () => new List<string>() { "ocelotclient2" }, false, "", "", new RateLimitRule("1s", 100, 3), 429, () => new List<ClientLimit>(), true))
                         .WithUpstreamHttpMethod(new List<string> { "Get" })
                         .Build())
                     .WithUpstreamHttpMethod(new List<string> { "Get" })
                     .Build());
